...
その為にgoogle等では「多くのサイトからリンクを集めているサイトは有益なコンテンツが掲載されている」と判断するようになっています。  
またgoogleは「ページランク」という概念で各WEBサイトを評価しています。評価基準は多岐にわたるのですが、ここで重要なのは外部からの一方的なリンクも評価基準になっている点です。  
外部からの一方的なリンク数が同様な二つのサイトがあった場合、リンクを貼ってくれているサイトの評価が高いサイトからリンクをもらっているサイトの方が評価が上になります。   
既に評価の高いサイトにリンクをもらっているサイトは、良い情報を提供してくれるサイトだろうと判断されるということです。  
...
サテライトサイトの注意点としては、  
   - サテライトサイトからメインサイトへのアンカーリンクのテキスト文章を複数用意した上で、自然な文章とする。  
   同一の文言でたくさんのリンクが貼られているとgoogleの方から不自然と見られてしまう可能性がある。
   - 複数のサテライトサイトを作る場合は、使用するブログサービスを変えるまた、IPアドレスを異なるものにする。
   IPアドレス等が一緒なので、同じ発信元ト認識されてしまい外部からのリンクと認識されない可能性がある。
   - サテライトサイトの方も内部施策をしっかりと行い、放置しない。
   「ページランク」で少し説明されていますが、いかに評価の高いサイトからのリンクをもらうかが重要なので、  
   放置してしまうとサテライトサイトの「ページランク」が低くなってしまい、逆にメインサイトの足を引っ張りかねません。

以上外部施策に関するまとめになります、SEO対策は外部リンクを集めるということを聞いたことがありましたが、意味が理解出来ました。  
ただ重要なのは、評価の低いサイトからいくつもリンクもらうよりも評価の高いサイト一つからリンクをもらう方がSEO対策としては有用だということですね。  
...
アルゴリズムの変更に関しては情報を収集をこまめに行い早めに情報をつかむことであたふたする必要が無くなります。  
問題ないサイトであれば2週間もあれば順位は戻るそうです。  
...
検索結果に出てこないなどの厳しいペナルティは手動ペナルティの場合のみです。手動ペナルティの場合、通知が来ているので通知内容に従い対応を行い  
再審査リクエストし合格することでペナルティが解除されます。  
ただペナルティが解除されてすぐにペナルティ前の状態になるとは限らないようです。  

ペナルティに関して、自動判定された場合に通知が来ないというのが一番怖いです。  
アルゴリズムに関する情報の収集と、ユーザー、google双方に好まれるサイトの構築運営を目指す言葉にすれば簡単ですが、なかなか難しい話と感じました。  

---
## 中締め

今回はWEBマーケティングの知識を生かしたWEBサイトの構築・運営に関して、実戦とは言えませんが、実際に使えれるサイト等も紹介しつつまとめてみました。  
個人的にが検索キーワードで使える無料のサイトの存在は面白いサイトだなと感じました。  
